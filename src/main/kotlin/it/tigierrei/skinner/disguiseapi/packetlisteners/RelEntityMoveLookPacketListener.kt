...
class RelEntityMoveLookPacketListener(plugin: Skinner, disguiseManager: DisguiseManager): PacketListener(plugin, disguiseManager) {
                        ...
                        if (integers != null && integers.size() > 0) {
                            ...
                            if (disguiseManager.isDisguised(entityID)) {
                                ...
                                if (fakeEntity != null) {
                                    ...
                                    val packet = PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook(
                                        fakeEntity.id,
                                        x,
                                        y,
                                        z,
